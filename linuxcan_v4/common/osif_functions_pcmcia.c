...
#if LINUX_2_6
  return 0;
  // QQQ KS servinfo_t removed in 2.6.15     return pcmcia_get_card_services_info(serv);
#else
...
int os_if_serv_report_error(OS_IF_CLIENT_HND hnd, OS_IF_ERR_INFO *err) {
  ...
  //QQQ KS pcmcia_reporterror removed in 2.6.15    return pcmcia_report_error(hnd, err);
#else
