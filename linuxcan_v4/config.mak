...
KV_DEBUGFLAGS  = -D_DEBUG=1 -DDEBUG=1 $(KV_LAPCAN_ON) $(KV_PCICAN_ON) $(KV_USBCAN_ON) $(KV_PCICANII_ON) $(KV_LEAF_ON) $(KV_VIRTUAL_ON)
...
#kernel 2.6
export KV_XTRA_CFLAGS_26       = $(KV_XTRA_COMMON_FLAGS) $(KV_NDEBUGFLAGS) -DLINUX_2_6=1 -DWIN32=0
export KV_XTRA_CFLAGS_DEBUG_26 = $(KV_XTRA_COMMON_FLAGS) $(KV_DEBUGFLAGS)  -DLINUX_2_6=1 -DWIN32=0
