/*
**                   Copyright 2005 by KVASER AB, Molndal, Sweden      
...
**
** Description:
**   Definitions for Filo (The Leaf)
**
**   This file is maintained in "m32firm/include" and shall be copied
**   (and committed there) to any other location where it is used (e.g
**   canlib) 
** ---------------------------------------------------------------------------
*/
#ifndef FILO_CMDS_H_
...
typedef struct {
    ...
    unsigned short padding2;      // Unused right now
} cmdGetCardInfoResp;
